...
| `hol-guard` | Use when protecting a local coding agent that uses Hugging Face Skills or the hf CLI with HOL Guard, reviewing Guard approvals or receipts, or scanning Agent Skills and MCP packages before use or release | [SKILL.md](skills/hol-guard/SKILL.md) |
