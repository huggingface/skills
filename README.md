...
| `iparq-parquet-inspector` | Inspect local or downloaded Parquet file metadata with the iParq CLI, including compression, encodings, physical and logical types, row groups, statistics, dictionary pages, page indexes, Bloom filters, and storage sizes. | [SKILL.md](skills/iparq-parquet-inspector/SKILL.md) |
