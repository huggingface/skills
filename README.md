...
| `hf-free-maxxing` | Every free Hugging Face capability in one CLI (hfx): storage, static hosting, CDN, $0 LLM inference, GPU bursts, data queries, OAuth identity, Docker pulls, webhooks — all live-verified. | [SKILL.md](skills/hf-free-maxxing/SKILL.md) |
