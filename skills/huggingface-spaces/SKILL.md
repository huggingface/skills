...
- **Docker** — arbitrary container. Use when you need a non-Python stack or a pre-built template (Streamlit, Argilla, Shiny, etc. — full list at [https://huggingface.co/docs/hub/spaces-sdks-docker](https://huggingface.co/docs/hub/spaces-sdks-docker)). Does **not** support ZeroGPU.
...
For the authoritative reference: [https://huggingface.co/docs/hub/spaces-overview](https://huggingface.co/docs/hub/spaces-overview)
...
All frontmatter options: [https://huggingface.co/docs/hub/spaces-config-reference](https://huggingface.co/docs/hub/spaces-config-reference)
...
## 5. Iterate on the Space, not locally
...
| **3D Spaces** — Model selection (all types), build/duplicate, 3D verification, CUDA setup, common output formats, viewers, headless Blender, and model-family recipes | `[references/3d-generation.md](references/3d-generation.md)`|
