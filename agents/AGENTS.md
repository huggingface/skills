...
hugging-face-jobs: `Use this skill when users want to run workloads on Hugging Face Jobs infrastructure. Covers UV scripts, Docker jobs, hardware selection, timeouts, environment variables, secrets, namespaces, popular images, monitoring, debugging, and saving results back to the Hub.`
